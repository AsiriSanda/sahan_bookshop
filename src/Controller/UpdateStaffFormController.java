...
public class UpdateStaffFormController implements Initializable {
    ...
    public void btnUpdateStaffOnAction(ActionEvent actionEvent) {
        try {
            boolean isUpdate = StaffController.updateStaff(new Staff(
                    staffID.getText(),
                    staffName.getText(),
    ...
    public void textFields_Key_Released(KeyEvent keyEvent) {
        Object response = ValidationUtil.validate(map, btnUpdateStaff);
